...
namespace SettingPanelEnhancementQX.Utils
{
    ...
    {
        public const string DefaultSettingTabButtonName = LocalizationHelper.KeyPrefix + "ModSettingButton";

        public const string DefaultSettingPanelName = LocalizationHelper.KeyPrefix + "ModSettingPanel";

        public const string DefaultSettingDropdownName = LocalizationHelper.KeyPrefix + "SettingDropdown";
